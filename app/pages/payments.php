                ...
                <?php foreach ($payments as $payment): ?>
                    <tr>
                        <td class="px-4 py-4 whitespace-nowrap">
                            <a href="/student_payments?student_id=<?php echo $payment['student_id']; ?>" class="text-sm font-medium text-primary-500 dark:text-primary-400 hover:underline"><?php echo htmlspecialchars($payment['student_name']); ?></a>
                        </td>
                        ...
                        <td class="px-4 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="/payments?delete=<?php echo $payment['id']; ?>" class="text-red-500 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300" onclick="return confirm('Are you sure you want to delete this payment?');">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
