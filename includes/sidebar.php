...
<div class="fixed inset-y-0 left-0 w-64 flex flex-col bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 z-40">
    ...
    <div class="flex-1 overflow-y-auto px-4 py-4">
        <nav class="space-y-1">
            ...
            <a href="index.php?page=school_info" class="flex items-center px-3 py-2 text-sm font-medium rounded-lg <?php echo ($page == 'school_info') ? 'bg-primary-50 dark:bg-gray-700 text-primary-600 dark:text-primary-400' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'; ?>">
